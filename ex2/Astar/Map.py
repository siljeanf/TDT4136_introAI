...
class Map_Obj():
    ...
    def get_cell_value(self, pos): #current position
        return self.int_map[pos[0], pos[1]]

    def get_goal_pos(self): #goal position
        return self.goal_pos

    def get_start_pos(self):#start position
        return self.start_pos

    def get_end_goal_pos(self):#end-goal-position
